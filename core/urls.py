...
urlpatterns = [
    ...
    path('gri-donusum/isle/', views.gri_donusum_isle_view, name='gri_donusum_isle'),
    path('binary-donusum/', views.binary_donusum, name='binary_donusum'),
    path('binary-donusum/isle/', views.binary_donusum_isle_view, name='binary_donusum_isle'),
